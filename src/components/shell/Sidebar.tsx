...
const MENU_ITEMS: MenuItem[] = [
  ...
  { key: "sozlesmeler", label: "Sözleşmeler", href: "/sozlesmeler", icon: FileText, roles: ["yonetici", "operasyon", "satis"] },
  { key: "talepler", label: "Personel Talepleri", href: "/talepler", icon: Users, roles: ["yonetici", "operasyon", "satis"] },
  { key: "aktif-isgucu", label: "Aktif İş Gücü", href: "/aktif-isgucu", icon: HardHat, roles: ["yonetici", "operasyon", "satis", "ik"] },
  { key: "randevular", label: "Randevular", href: "/randevular", icon: CalendarCheck, roles: ["yonetici", "operasyon", "satis"] },
  { key: "gorevler", label: "Görevler", href: "/gorevler", icon: ListChecks, roles: ["yonetici", "operasyon", "satis", "ik"] },
  { key: "evraklar", label: "Evraklar", href: "/evraklar", icon: FolderOpen, roles: ["yonetici", "operasyon", "satis", "ik"] },
